				...
				case 1:
					if (creada) {
						...
						do {
							...
							case 4:
								//Supongo que aqui usaremos aqui pila ya que es el ultimo objeto de la lista: reply: exactamente compañeroooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
								do {
									system("cls");
